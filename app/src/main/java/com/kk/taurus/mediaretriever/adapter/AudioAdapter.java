...
public class AudioAdapter extends RecyclerView.Adapter<AudioAdapter.AudioViewHolder>{
    ...
    private MetadataKey key_album = new MetadataKey(MetaKeys.SystemMetaKeys.METADATA_KEY_ALBUM,MetaKeys.FFmpegKeys.METADATA_KEY_ALBUM,"专辑");
    ...
    public void onBindViewHolder(final AudioViewHolder holder, int position) {
        ...
        MediaRetriever.withAudio(item.getPath()).placeHolder(R.mipmap.ic_launcher).into(holder.cover);
        ...
        if(cacheMeta!=null){
            ...
            MediaRetriever.withAudio(item.getPath()).metaKeys(metadataKeys).into(new OnMediaRetrieverLoadCallback() {
                @Override
    ...
    public static class AudioViewHolder extends RecyclerView.ViewHolder{
        ...
        public AudioViewHolder(View itemView) {
            super(itemView);
            cover = itemView.findViewById(R.id.audio_cover);
            info = itemView.findViewById(R.id.audio_info);
        }
    }
